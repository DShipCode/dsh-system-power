...
电源按钮位于设置页头部、“打开配置文件”按钮正右侧：

![设置页头部电源按钮](assets/settings-header.png)

点击后弹出 **关闭 / 重启** 菜单：

![电源菜单](assets/power-menu.png)

执行操作时弹出全屏遮罩：

![正在关闭](assets/shutting-down.png)

宿主退出后，遮罩停留在静态提示：

![已关闭](assets/closed.png)

重启同样有提示，新进程就绪后页面自动刷新：

![正在重启](assets/restarting.png)
